...
void handleRoot() {
    String page = R"rawliteral(
        ...
        <div style="margin-top:20px;">
            <label for="PspInput">Pressure Setpoint:</label>
...
double volts3 = 0.0;
double volts1 = 0.0;
double volts1scaled = 0.0;
double pressure = 0.0;
double unscaled_pressure = 0.0;
double readPressure()
{
    ...
    else
    {
        ...
        volts1scaled = volts1 * (5.0 / volts3);
        unscaled_pressure = ((150.0 / 4.0) * volts1) - (150.0 / 8.0);
        pressure_psi = ((150.0 / 4.0) * volts1scaled) - (150.0 / 8.0);
        //pressure = pressure_psi;
        pressure = unscaled_pressure;
    }
    return pressure;
}
...
void loop()
{
    ...
    if (millis() - lastSerialMonitorOutput >= GraphPlotDelay) {
        ...
        Serial.printf("ADC3 Voltage: %.4f\n", volts3);
        Serial.printf("ADC1 Pressure RAW: %.4f\n", unscaled_pressure);
